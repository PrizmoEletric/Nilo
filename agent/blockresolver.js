...
// ============================================================
//
// const { resolveBlock, findNearestBlock, searchRegistry } = require('./blockResolver')
//
// // Resolver um bloco vanilla (stateId correto mesmo em modded)
// const stone = resolveBlock(bot, 'stone')
// // → { id: 1, stateId: 1, name: 'stone' }  (valores reais do servidor)
//
// // Resolver um bloco de mod
// const alloy = resolveBlock(bot, 'create:andesite_alloy')
//
// // Navegar até o bloco mais próximo
// const log = findNearestBlock(bot, 'oak_log', 32)
// if (log) {
//   const { GoalGetToBlock } = require('mineflayer-pathfinder').goals
//   bot.pathfinder.setGoal(
//     new GoalGetToBlock(log.position.x, log.position.y, log.position.z)
//   )
// }
//
// // Descobrir nome exato de bloco de mod
// searchRegistry(bot, 'furnace')  // lista tudo que contém "furnace"
//
// // StateId exato de bloco no mundo (quando estado importa)
// const stateId = getStateIdAt(bot, bot.entity.position.offset(0, -1, 0))
// ============================================================
